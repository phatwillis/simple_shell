...
/**
 * count_Args - it counts the number of command line arguments
...
/**
 * split_string - this function tokenize the string into array
 * @cmd: is the command to be tokenized
 * Return: to the tokenized command
 */
...
char **split_string(const char *cmd)
{
	...
	num_tokens = count_Args(copy_cmd);
...
/**
 * execute_cmd - it executes command
...
/**
 * free_new_av - it frees the new_av variable
 * used in the execve function
 *
 * @new_av: is the variable to be freed
 */
