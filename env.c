...
/**
 * create_node - it creates a new node to the list
 * @data: is the variable to set
 * @number: it keeps track of the varible
...
/**
 * add_to_list - it adds a node to the list
 * @head: it is the head of the linked list
 * @new_node: it is the node to be added
 */
...
/**
 * print_env - it prints the node to the stderr
 * @head: it is the head of the linked list
 * Return: nothing
 */
...
/**
 * handle_env - it handles the env built-in
 * Return: 0 on success
 */
...
/**
 * free_env - it frees the list
 * @head: its the head to the linked list
 */
